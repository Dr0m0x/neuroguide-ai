...
Commission on Dementia Prevention (2024) plus APOE4 genetic status.
...
def _generate_synthetic_data(n: int = 2000, seed: int = 42):
    ...
    plus APOE4 genetic risk (Bellenguez et al. 2022, Nature Genetics).
    """
    ...
    # Approximate population frequencies: ~60% no allele, ~30% one allele, ~2-3% homozygous
    ...
    score = (
          0.07 * (age - 60)
        - 0.12 * (edu - 12)
        # APOE4: heterozygous ≈ +1.5, homozygous ≈ +3.5 (non-linear step)
    ...
    def predict(self, features: dict) -> dict:
        ...
        return {
            ...
            "disclaimer": (
                ...
                "Lancet Commission on Dementia Prevention (2024) and APOE4 genetic epidemiology. "
